...
//   Timer? _markAsReadDebounce; // Thêm debounce cho mark as read
//   bool _isTyping = false;
//   bool _shouldScrollToBottom = true;
//   bool _isScreenActive = true; // Thêm flag để track screen active state
...
//     // Track khi app đang active hay không
...
//     // QUAN TRỌNG: Chỉ mark as read khi có tin nhắn mới từ người khác
...
//     if (!hasUnread) {
//       debugPrint('No unread messages, skipping mark as read');
//       return;
//     }
...
//     // Reset unread count trong conversation provider
//     _conversationProvider?.resetUnreadCount(widget.conversation.conversationId);

//     // Cập nhật total unread count
//     await _conversationProvider?.loadTotalUnreadCount();
//   }
...
//     _typingTimer?.cancel();
//     _scrollDebounce?.cancel();
//     _markAsReadDebounce?.cancel(); // Cancel debounce timer
//     _stopTyping();

//     _messageProvider?.leaveConversation(widget.conversation.conversationId);
//     _conversationProvider?.loadTotalUnreadCount();
...
class _MessageScreenState extends State<MessageScreen>
  ...
  Future<void> _markAllAsRead() async {
    ...
    // Reset unread count sẽ được xử lý tự động qua socket event 'all_messages_read'
  }
