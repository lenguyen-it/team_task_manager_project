...
//               children: [
//                 // Unread count badge
//                 if (conversationProvider.totalUnreadCount > 0)
//                   Container(
//                     width: double.infinity,
//                     padding: const EdgeInsets.all(8),
//                     color: Colors.blue[50],
//                     child: Text(
//                       'Bạn có ${conversationProvider.totalUnreadCount} tin nhắn chưa đọc',
//                       textAlign: TextAlign.center,
//                       style: TextStyle(
...
//     // Add this check to ensure the widget is still active before using context
//     if (!mounted) return;
...
//         // Tìm ListMessageScreen context để reload
//         listContext
...
class _ConversationTile extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final hasUnread = (conversation.unreadCountForEmployee ?? 0) > 0;
